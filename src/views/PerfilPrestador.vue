    ...
    <div class="profile-screen__content">
      <div class="profile-screen__panel profile-screen__panel--left">
        <div class="profile-screen__photo-card">
          ...
          <div class="profile-screen__name-block">
            ...
            <h3>Claudio Mecânico</h3>
          </div>
        </div>
        <div class="profile-screen__service-desc">
      ...
      <div class="profile-screen__panel profile-screen__panel--right">
        ...
        <div class="profile-screen__form">
          ...
          <div class="profile-screen__field profile-screen__field--half">
            <input type="text" placeholder="N de Registro CNH" readonly />
          </div>
          <div class="profile-screen__field profile-screen__field--half">
            <input type="text" placeholder="Data de Validade" readonly />
          </div>
          <div class="profile-screen__field profile-screen__field--half">
            <input type="text" placeholder="Categoria" readonly />
          </div>
        </div>
        ...
        <div class="profile-screen__form">
          ...
          <div class="profile-screen__field profile-screen__field--half">
            <input type="text" placeholder="Código Renavam" readonly />
          </div>
          <div class="profile-screen__field profile-screen__field--half">
            <input type="text" placeholder="Placa do Veículo" readonly />
          </div>
        </div>
        ...
        <div class="profile-screen__form">
          ...
          <div class="profile-screen__field profile-screen__field--half">
            <select disabled>
              <option>Categoria (Opcional)</option>
            </select>
          </div>
        </div>
...
.profile-screen__service-desc {
  width: 100%;
  margin-top: 16px;
}
.profile-screen__service-desc label {
  font-weight: 600;
  margin-bottom: 4px;
  display: block;
}
.profile-screen__service-desc textarea {
  width: 100%;
  min-height: 100px;
  border-radius: 12px;
